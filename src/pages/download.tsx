            ...
            <div className="items-center justify-center gap-16 text-center md:flex md:text-left">
              <div className="order-last mb-6 space-y-6 md:mb-0 md:w-7/12 lg:w-6/12">
                ...
                <div className="flex flex-wrap justify-center gap-4 md:justify-start lg:gap-6">
                  <a
                    href="https://github.com/GPT-AI-Flow/gpt-ai-flow-doc-docusaurus/releases/download/v0.1.37/GPT.AI.Flow-0.1.37.dmg"
                  ...
                  <a
                    href="https://github.com/GPT-AI-Flow/gpt-ai-flow-doc-docusaurus/releases/download/v0.1.37/GPT.AI.Flow-0.1.37-arm64.dmg"
                    title="Download for Mac"
                    aria-label="Download for Mac"
                    className="download-link-button"
                  >
                  ...
                  <a
                    href="https://github.com/GPT-AI-Flow/gpt-ai-flow-doc-docusaurus/releases/download/v0.1.37/GPT.AI.Flow.Setup.0.1.37.exe"
