...
const Testimonials = () => {
  const comments: IComment[] = [
    ...
    },
    {
      ...
      content:
        'GPT AI Flow 以前可能存在一些小问题，比如某些情境理解技术术语时稍显生疏，但它的整体性能足以成为技术博文创作的一款神器。想象一下，你无需再费尽脑力去翻译晦涩的技术术语，GPT AI Flow 能够以平易近人的方式呈现出来，给你的读者留下深刻印象。',
    },
    {
      authorName: '清风明月最好',
      authorImg:
      ...
      content:
        '虽然开始使用的时候我是有些怀疑的，毕竟是AI，会不会失去人的创意独特性呢？但实际体验后，我被彻底打服了。产品效率极高，营销文案更具创新和吸引力，让我们在竞争激烈的市场中独树一帜。',
    },
  ];
