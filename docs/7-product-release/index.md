...
1. **快捷键功能**: 现在，按下 `Alt + Space` 键可以方便地显示/隐藏对话窗口，并且光标会自动聚焦到主窗口并可编辑。另外，我们还加入了 `Shift + Space` 键，专门用于控制主窗口的显示和隐藏。
...
![](./img/2023-09-03-img-1-shorcut-to-show-and-hide-mainWindow.gif)
